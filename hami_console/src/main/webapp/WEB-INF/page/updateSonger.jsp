            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="widget">
                        ...
                        <!--隐藏的srid字段，传递艺人主键 -->
                        <input type="hidden" name="srid" value="${songer.srid}" />
                        ...
                        <div class="widget-content">
                            ...
                            <div class="body">
                                                ...
                                                <div class="image-row">
                                                    <div class="image-set">
                                                        <a class="example-image-link" href="${filePath}${songer.pic}" data-lightbox="example-set" title="Click on the right side of the image to move forward.">
                                                            <!-- 回显头像 -->
                                                            <img id="songerImg" class="example-image" src="${filePath}${songer.pic}" alt="艺人头像" width="150" height="150" />
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="form-actions text-right">
                                    <button id="submitSonger" class="btn btn-primary" type="submit"> 修改 </button>
                                </div>

                                    ...
                                    <table class="table table-striped table-images" style="color: white;font-size: 14px">
                                        ...
                                        <c:forEach items="${page.list}" var="songer">
                                            <tr>
                                                ...
                                                <td><button modify srid ="${songer.srid}" data-ing ="${songer.pic}" class="btn btn-sm btn-primary" type="button"> 修改 </button>
                                                    <button  del srid ="${songer.srid}" data-toggle="button" class="btn btn-sm btn-warning" type="button"> 删除 </button></td>
                                            </tr>
                                        </c:forEach>
